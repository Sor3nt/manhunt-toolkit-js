...
import {RGB_S3TC_DXT1_Format, RGBA_S3TC_DXT3_Format, RGBA_S3TC_DXT5_Format} from "../../../../Vendor/three.module.mjs";
import helper from "../../../../Helper.mjs";
...
export default class TextureNative extends Chunk{
    ...
    list(){
        ...
        switch (platform) {
            ...
            default:
                helper.log("RW", `TextureNative, Unknown Platform ${platform}!`, 'warn');
                debugger;
                break;
        }
    ...
    parse(){
        ...
        switch (this.result.platform) {
            ...
            default:
                helper.log("RW", `TextureNative, Unknown Platform ${this.result.platform}!`, 'error');
                debugger;
                break;
        }
    ...
    parsePc(struct){
        ...
        switch ( header.rasterFormat & Renderware.RASTER_MASK ) {
            ...
            case Renderware.RASTER_565:
                this.texture.format = TextureFormat.FORMAT_BC1_RGBA;
                break;

            case Renderware.RASTER_1555:
                this.texture.format = TextureFormat.FORMAT_BC1_RGB;
                break;

            case Renderware.RASTER_4444:
                this.texture.format = TextureFormat.FORMAT_BC2_RGBA;
                break;
