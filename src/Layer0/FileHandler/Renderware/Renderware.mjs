...
import Dummy from './Chunk/Dummy.mjs'

import AtomicSect from './Chunk/AtomicSect.mjs'
import Atomic from "./Chunk/Atomic.mjs";
import BinMesh from "./Chunk/BinMesh.mjs";
import TextureNative from './Chunk/TextureNative.mjs'
import TexDictionary from './Chunk/TexDictionary.mjs'
import FrameList from "./Chunk/FrameList.mjs";
import PlaneSect from "./Chunk/PlaneSect.mjs";
import Frame from "./Chunk/Frame.mjs";
import Toc from "./Chunk/Toc.mjs";
import HAnim from "./Chunk/HAnim.mjs";
// import HAnimPlugin from "./Chunk/HAnimPlugin.mjs";
import Geometry from "./Chunk/Geometry.mjs";
import MatList from "./Chunk/MatList.mjs";
import Material from "./Chunk/Material.mjs";
import Texture from "./Chunk/Texture.mjs";
import RwString from "./Chunk/RwString.mjs";
import Skin from "./Chunk/Skin.mjs";
import Clump from "./Chunk/Clump.mjs";
import GeometryList from "./Chunk/GeometryList.mjs";
import Extension from "./Chunk/Extension.mjs";
import ReflectionMat from "./Chunk/ReflectionMat.mjs";
import World from "./Chunk/World.mjs";
import CollisPlugin from "./Chunk/CollisPlugin.mjs";
import MaterialEffects from "./Chunk/MaterialEffects.mjs";
import RightToRender from "./Chunk/RightToRender.mjs";
import VertexFormat from "./Chunk/VertexFormat.mjs";
// import Chunk from "./Chunk/Chunk.mjs";

import PiTexDictionary from "./Chunk/PiTexDictionary.mjs";
import ChunkGroupStart from "./Chunk/ChunkGroupStart.mjs";
import ChunkGroupEnd from "./Chunk/ChunkGroupEnd.mjs";
import PrtStdPlugin from "./Chunk/PrtStdPlugin.mjs";
import Image from "./Chunk/Image.mjs";
import UserDataPlugin from "./Chunk/UserDataPlugin.mjs";
import Animation from "./Chunk/Animation.mjs";
...
export default class Renderware{
    ...
    static findChunk(chunk, type) {
        ...
        if (found.length > 1){
            helper.log(this.tag, `Tried to get exact one chunk with type ${type} but multiple was found!`, 'error');
            debugger;
        }
                ...
                if (binary.remain() >= lookupDeep * 4){
                    ...
                    while(lookupDeep--){
                        ...
                        if (binary.current() - 12 - currentStart !== header.size){
                            ...
                            helper.log(this.tag, `Renderware Chunk size correction from ${header.size} to ${binary.current() - 12 - currentStart}!`, 'info');
                        }
    ...
    static processChunk( binary, rootData) {
        ...
        rootData = rootData || {};
        rootData = rootData.materials === undefined ? {
            materials: [],
            textures: [],
            skins: [],
            frames: [],
